...
function sec_send_headers(): void {
    ...
    $csp = "default-src 'self'; "
         ...
         . "img-src 'self' data: blob: * "
             ...
             . "https://img.anili.st "
             . "https://cover-prod.crazytalkai.com https://*.crazytalkai.com "
             . "https://static.aniwaves.ru https://aniwaves.ru "
             . "https://drama.hnivj.com https://*.hnivj.com "
             . "https://narto-drama.com https://*.narto-drama.com "
             . "https://*.aliyuncs.com https://*.cloudfront.net "
             . "https://*.akamaized.net https://*.fastly.net https://*.imgix.net; "
         . "media-src 'self' blob: *; "
...
function sec_verify_stream_token(string $token, string $type = '', int $id = 0): bool {
    ...
    // دعم التوكنات القديمة (4 أجزاء) والجديدة (5 أجزاء)
    if (count($parts) === 4) {
        // توكن قديم بدون session fingerprint — نقبله لكن نسجّل تحذير
