...
// ── security: only allow lookmovie2 domains + public (non-private) CDN hosts ──
...
// lookmovie streams from various CDN hostnames — allow any public (non-private) host
if (!$isAllowed) {
...
// ── for TS segments / other: pass through ────────────────────────────────────
if ($range) {
